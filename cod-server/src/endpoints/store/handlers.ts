  ...
  return c.json(
    {
      ...
      data: {
        ...
        sidePadding: lp.sidePadding,
        contentMaxWidth: lp.contentMaxWidth,
        showImages: lp.showImages,
        showOrderForm: lp.showOrderForm,
        showStickyCta: lp.showStickyCta,
        backgroundColor: lp.backgroundColor,
        buttonColor: lp.buttonColor,
        buttonTextColor: lp.buttonTextColor,
        buttonRadius: lp.buttonRadius,
